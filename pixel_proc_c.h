...
enum {
	...
	PIXEL_PROC_14BIT_FLOYD_STEINBERG_DITHERING,
	PIXEL_PROC_MAX
};
...
#define CALL_IMPL(func, ...) \
	( mode == PIXEL_PROC_8BIT ? pixel_proc_8bit::##func(__VA_ARGS__) : \
	  ...
	  mode == PIXEL_PROC_14BIT_FLOYD_STEINBERG_DITHERING ? pixel_proc_14bit_f_s_dithering::##func(__VA_ARGS__) : \
...
#include "pixel_proc_c_14bit_f_s_dithering.h"
